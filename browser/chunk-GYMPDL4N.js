...
var _MePage = class _MePage {
};
_MePage.\u0275fac = function MePage_Factory(t) {
  return new (t || _MePage)();
};
_MePage.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MePage, selectors: [["app-me"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 1, consts: [[3, "translucent"]], template: function MePage_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-header", 0)(1, "ion-toolbar")(2, "ion-title");
    \u0275\u0275text(3, "Me");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(4, "ion-content");
    \u0275\u0275text(5, "Me");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
}, dependencies: [CommonModule, IonicModule, IonContent, IonHeader, IonTitle, IonToolbar, CoreModule] });
var MePage = _MePage;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MePage, { className: "MePage", filePath: "src/app/core/pages/me/me.page.ts", lineNumber: 14 });
})();
export {
  MePage
};
