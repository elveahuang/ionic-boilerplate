...
var routes = [
  {
    ...
    children: [
      {
        path: "home",
        loadComponent: () => import("./chunk-HAQ2SOO3.js").then((m) => m.HomePage)
      },
      {
        path: "discover",
        loadComponent: () => import("./chunk-T7T5OM6J.js").then((m) => m.DiscoverPage)
      },
      {
        path: "me",
        loadComponent: () => import("./chunk-GYMPDL4N.js").then((m) => m.MePage)
      },
      {
        path: "",
  ...
  {
    path: "settings",
    loadComponent: () => import("./chunk-EZ4UTNK6.js").then((m) => m.SettingsPage)
  },
  {
    path: "about",
    loadComponent: () => import("./chunk-LBHR42R2.js").then((m) => m.AboutPage)
  }
];
