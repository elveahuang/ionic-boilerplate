...
_SettingsPage.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SettingsPage, selectors: [["app-settings"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 5, vars: 0, template: function SettingsPage_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ion-header")(1, "ion-toolbar")(2, "ion-title");
    \u0275\u0275text(3, "settings");
    \u0275\u0275elementEnd()()();
    \u0275\u0275element(4, "ion-content");
  }
}, dependencies: [CommonModule, IonicModule, IonContent, IonHeader, IonTitle, IonToolbar, CoreModule] });
var SettingsPage = _SettingsPage;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SettingsPage, { className: "SettingsPage", filePath: "src/app/core/pages/settings/settings.page.ts", lineNumber: 14 });
})();
export {
  SettingsPage
};
