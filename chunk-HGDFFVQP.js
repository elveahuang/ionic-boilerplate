...
import "./chunk-3UXFX6EL.js";
import "./chunk-WVTZFYF6.js";
import {
  transition
} from "./chunk-25YLPDTL.js";
import {
...
// node_modules/.pnpm/@ionic+core@8.2.0/node_modules/@ionic/core/dist/esm/ion-app_8.entry.js
  ...
  componentDidLoad() {
    {
      rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./chunk-QDG7LY5V.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./chunk-DGPO4HFW.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./chunk-FF3LTMNF.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./chunk-3UZSBVJK.js");
        ...
        if (typeof window !== "undefined") {
          import("./chunk-LK4I6QYL.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./chunk-SECPUMAL.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
  /**
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./chunk-MJTABSVM.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
