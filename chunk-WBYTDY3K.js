...
var _DiscoverPage = class _DiscoverPage {
};
_DiscoverPage.\u0275fac = function DiscoverPage_Factory(t) {
  return new (t || _DiscoverPage)();
};
_DiscoverPage.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DiscoverPage, selectors: [["app-discover"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 6, vars: 0, template: function DiscoverPage_Template(rf, ctx) {
  if (rf & 1) {
...
var DiscoverPage = _DiscoverPage;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(DiscoverPage, { className: "DiscoverPage", filePath: "src/app/core/pages/discover/discover.page.ts", lineNumber: 14 });
})();
export {
  DiscoverPage
};
